export const PERMISSIONS = {
  ...
  SUPPLIER_PAYMENT_VIEW: 'supplier.payment.view',
  ...
  CUSTOMER_COLLECT_PAYMENT: 'customer.collect_payment',
  CUSTOMER_VIEW_PAYMENTS: 'customer.view_payments',
  ...
  CASH_VIEW_SHIFT: 'cash.view_shift',
  CASH_IN: 'cash.cash_in',
  CASH_OUT: 'cash.cash_out',
  CASH_ADJUST: 'cash.adjust',
  CASH_VIEW_HISTORY: 'cash.view_history',
  EXPENSE_VIEW: 'expense.view',
  EXPENSE_CREATE: 'expense.create',
  EXPENSE_EDIT: 'expense.edit',
  EXPENSE_POST: 'expense.post',
